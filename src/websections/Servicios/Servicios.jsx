  ...
  return (
    <section className={styles.serviciosSection} id="servicios">
      ...
      <div className={styles.serviciosGrid}>
        {/* Primera fila con un delay inicial */}
        <ServicioCard
          icon={<Svg route="/src/assets/animated/world.json" />}
          ...
          modalData={{
            ...
            image: { src: "src/assets/images/modals_images/desarrollo_web.jpg", alt: "Desarrollo Web" },
            tabs: [
              {
                label: "¿Qué incluye?",
                content: (
        ...
        />
        <ServicioCard
          icon={<Svg route="/src/assets/animated/responsive.json" />}
          titulo="Diseño Responsivo"
          descripcion="Tu página se verá perfecta en cualquier dispositivo."
          animation="fade-up"
          modalData={{
            ...
            image: { src: "src/assets/images/modals_images/responsive.jpg", alt: "Diseño Responsivo" },
            tabs: [
              {
        ...
        <ServicioCard
          ...
          modalData={{
            ...
            image: { src: "src/assets/images/modals_images/mantenimiento.png", alt: "Soporte Técnico" },
            tabs: [
              {
                label: "Servicios",
                icon: <FaTools />,
        ...
        />
        {/* Segunda fila con más delay */}
        <ServicioCard
          icon={<Svg route="/src/assets/animated/world.json" />}
          titulo="Hosting y dominio"
          descripcion="Gestión de alojamiento web y registro de dominios."
          animation="fade-right"
          modalData={{
            ...
            image: { src: "src/assets/images/modals_images/hosting.webp", alt: "Hosting" },
            tabs: [
              {
                label: "Servicios",
                icon: <FaServer />,
        ...
        <ServicioCard
          ...
          modalData={{
            ...
            image: { src: "src/assets/images/modals_images/redes.webp", alt: "Redes Sociales" },
            tabs: [
              {
                label: "Integraciones",
                icon: <FaShare />,
        ...
        <ServicioCard
          ...
          modalData={{
            ...
            image: { src: "src/assets/images/modals_images/diseño.jpg", alt: "Diseño UX/UI" },
            tabs: [
              {
                label: "Proceso",
                icon: <FaPaintBrush />,
